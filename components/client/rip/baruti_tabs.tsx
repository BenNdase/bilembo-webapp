...
const TabsRipBaruti = () => {
  ...
  const LinkDemoBiography = (e: any) => {
    e.preventDefault();
    router.push(`/memorial/leonard_baruti_kasongo`);
  };
  const LinkDemoMemories = (e: any) => {
    e.preventDefault();
    router.push(`/memorial/leonard_baruti_kasongo/souvenirs`);
  };
  const LinkDemoTestimony = (e: any) => {
    e.preventDefault();
    router.push(`/memorial/leonard_baruti_kasongo/temoignages`);
  };
